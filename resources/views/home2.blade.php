...
<div class="container-fluid p-0 mb-5 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    ...
                                    <a href="/about" class="btn btn-secondary rounded-pill py-sm-3 px-sm-5 ms-3">About Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <p><i class="fa fa-check text-primary me-3"></i>Organic Vegetable</p>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item position-relative bg-white p-5 mt-4">
                    ...
                    <p class="mb-4">Sayuran yang saya beli disini sangat fresh dan segar. Recommended!</p>
                ...
                <div class="testimonial-item position-relative bg-white p-5 mt-4">
                    <i class="fa fa-quote-left fa-3x text-primary position-absolute top-0 start-0 mt-n4 ms-5"></i>
                    <p class="mb-4">Terimakasih KiosTani! sudah membantu kami dalam pengadaan bahan baku sayuran yang berkualita untuk bisnis kami.</p>
                    <div class="d-flex align-items-center">
                        <img class="flex-shrink-0 rounded-circle" src="img/testimonial-2.jpg" alt="">
                        <div class="ms-3">
                            <h5 class="mb-1">BurgerBar</h5>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-header text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-5 mb-3">Our Group</h1>
                <p>Kelompok 9 - Kios Tani</p>
            </div>
            <div class="row g-3">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="img-fluid" src="foto/rehan.png" alt="">
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">Achmad Fahresya Rayhannur-1202204161</a>
                        <div class="text-muted border-top pt-4">
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Project Manager</small><br>
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Back-end Developer</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <img class="img-fluid" src="foto/sonia.png" width="1780" height="2109" alt="">
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">Sonia Frisca Putri Ardhana-1202200221</a>
                        <div class="text-muted border-top pt-4">
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>UI Designer</small><br>
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Front End Developer</small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <img class="img-fluid" src="foto/almira.png" alt="">
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">Almira Syamsi Nur Insan-1202200164</a>
                        <div class="text-muted border-top pt-4">
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>System Analyst</small><br>
                            <small class="me-3"><i class="fa fa- text-primary me-2"></i></small>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <img class="img-fluid" src="foto/ais.png" alt="">
                    <div class="bg-light p-4">
                        <a class="d-block h5 lh-base mb-4" href="">Aisyah Wulan Aydila-1202204044</a>
                        <div class="text-muted border-top pt-4">
                            <small class="me-3"><i class="fa fa-user text-primary me-2"></i>Finance</small><br>
                            <small class="me-3"><i class="fa fa- text-primary me-2"></i></small>
                        </div>
                    </div>
                </div>
